      ...
      <div className="flex items-center gap-2.5">
        ...
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
            <path d="M22.65 14.39L12 22.13 1.35 14.39a.84.84 0 01-.3-.94l1.22-3.78 2.44-7.51a.42.42 0 01.82 0l2.44 7.51h8.06l2.44-7.51a.42.42 0 01.82 0l2.44 7.51 1.22 3.78a.84.84 0 01-.3.94z" fill="#fc6d26"/>
          </svg>
          GitLab
        </button>
